...
namespace ConsoleApplication4
{
    class CommandExam
    {
        ...
        {
        string OleCnString = ("Provider=OraOLEDB;data source=topcredu;User ID = scott; Password = tiger");
            ...
            try
 {
                ...
                int rowsadded = cmdAdd.ExecuteNonQuery();//select 제외 실행
